...
- `apps/frontend`: Next.js frontend using Supabase Auth and an OpenAPI-generated TypeScript client for backend calls.
...
- Root `justfile`: Common development commands.
...
- Frontend app: Next.js exposed at `http://localhost:3000`, currently a home page with Supabase email/password sign-in and starter document workspace.
